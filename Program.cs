...
namespace _20_7_23_Assign_11
{
     internal class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("Enter initial data for the LargeDataCollection:");
            ...
            try
            {
                ...
                Console.WriteLine("\nEnter additional elements to add to the collection:");
                ...
                Console.WriteLine("\nEnter elements to remove from the collection:");
